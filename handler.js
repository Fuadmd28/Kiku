...
const fixdelay = require('./kemiibayashi/fixdelay')
...
global.dfail = (type, m, conn) => {
    ...
    let msg = {
		...
		premium: '🔒 Sorry, this command is for premium members only.',
		group: '🔒 Sorry, this command can only be used in groups.',
		vip: '🔒 Sorry, this command is for vip members only.',
...
renderLargerThumbnail: true
    ...
    let msgg = {
        unreg: `🚩 ʜᴇʟʟᴏ *@${m.sender.split("@")[0]}* ꜱɪʟᴀʜᴋᴀɴ ᴅᴀꜰᴛᴀʀ ᴋᴇ *ᴅᴀᴛᴀʙᴀꜱᴇ* ʙᴏᴛ ᴛᴇʀʟᴇʙɪʜ ᴅᴀʜᴜʟᴜ ᴊɪᴋᴀ ɪɴɢɪɴ ᴍᴇɴɢɢᴜɴᴀᴋᴀɴ ꜰɪᴛᴜʀ ʙᴏᴛ.\n\n*ᴍᴀɴᴜᴀʟ ᴇxᴀᴍᴘʟᴇ:*\n.ᴅᴀꜰᴛᴀʀ ᴋᴇᴍɪɪ.9\n\n*ᴇᴍᴀɪʟ ᴇxᴀᴍᴘʟᴇ:*\n.ʀᴇɢ ${global.namebot}@ɢᴍᴀɪʟ.ᴄᴏᴍ\n\n🚩 ᴍᴇɴɢᴀʙᴀɪᴋᴀɴ ᴘᴇꜱᴀɴ ɪɴɪ ꜱᴇʟᴀᴍᴀ 5x, ᴅᴀᴘᴀᴛ ᴍᴇᴍʙᴜᴀᴛ ʙᴏᴛ ᴍᴇᴍʙʟᴏᴋɪʀ ᴀɴᴅᴀ!!`
    }[type]
